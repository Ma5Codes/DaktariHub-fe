    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="bg-light p-8 rounded-lg mb-12 text-center">
        ...
        <p className="text-lg text-secondary mb-4">
          DaktariHub- Hospital Management System is a cutting-edge solution designed to streamline healthcare operations and improve patient care.
        </p>
      ...
      <div className="bg-light p-8 rounded-lg">
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            />
            <h3 className="text-xl font-semibold mb-2 text-primary">Ma5Codes</h3>
