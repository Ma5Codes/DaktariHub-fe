...
const Home = () => {
    ...
    const testimonials = [
      {
          name: "John Doe",
          text: "Daktari Hub has revolutionized how I manage my healthcare. It's so easy to use!",
          image: "https://randomuser.me/api/portraits/men/32.jpg",
      },
      {
          name: "Jane Smith",
          text: "I love how I can access all my medical information in one place. Great job, Daktari Hub!",
          image: "https://randomuser.me/api/portraits/women/44.jpg",
      },
      {
          name: "Mike Johnson",
          text: "Booking appointments has never been easier. Daktari Hub is a game-changer!",
          image: "https://randomuser.me/api/portraits/men/22.jpg",
      },
      {
          name: "Emily Davis",
          text: "The staff is incredibly helpful and caring. I highly recommend Daktari Hub!",
      ...
      {
          name: "Mary Brown",
          text: "I appreciate the convenience of managing everything online. Thank you, Daktari Hub!",
            ...
            >
              {isLoggedIn ? (
                userRole === 'doctor' ? (
                  ...
                  'Access quality healthcare services and book appointments'
                )
              ) : (
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {userRole === 'doctor' ? (
                  <>
                    ...
                    <Link to="/patients">
                      <motion.button
                        className="bg-light text-primary font-bold py-2 px-6 rounded-full hover:bg-accent hover:text-primary transition duration-300"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                      >
                        View Patients
    ...
    <div className="md:w-1/2 md:pl-8 flex flex-col justify-between"> {}
      ...
      <div className="flex-grow"> {}
        <p className="text-gray-600 mb-4 text-[1.1rem] font-montserrat">
          DaktariHub is a cutting-edge healthcare management system
        ...
        <p className="text-gray-600 mb-4 text-[1.1rem] font-montserrat">
          With DaktariHub, you can easily manage appointments, access
    ...
    <div className="container mx-auto px-4">
        ...
        <section className="cta bg-primary text-light py-20 rounded-3xl mx-4 mb-4">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mb-8">
              Join DaktariHub today and experience the future of healthcare
              management.
            </p>
            <Link to="/signup">
              <motion.button
